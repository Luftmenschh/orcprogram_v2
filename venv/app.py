...
app.layout = html.Div(children=[
    ...
    html.Div(className="banner", children=[
        ...
        html.Div(className='container scalable', children=[
            ...
            html.A(
                # html.Img(src="https://www.qub.ac.uk/home/media/Media,767339,en.svg"),
            ...
            [
                ...
                children=[
                    ...
                    drc.Card([
                        ...
                        #  adds the ORC Configuration header to the first card
                        html.H6('ORC Configuration'),
...
#                        # Heat Source dropdown that is fixed
                    ...
                    # second card which contains the the temperature and efficiency slider components
                    drc.Card([

                        #
                        html.H6('Variable Parameters'),
